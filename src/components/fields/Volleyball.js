...
// ==========================
// Component chính: Trang Bóng Chuyền
// ==========================
const Volleyball = () => {
    ...
    // Lọc sân bóng chuyền theo từ khóa truyền từ Home (nếu có)
    useEffect(() => {
        let result = fields.filter(
            (field) => field.type?.name?.toLowerCase() === "bóng chuyền"
        );
        ...
        <div className="font-sans">
            ...
            <main className="content-wrapper">
                ...
                <section className="fields-list-container">
                    <h1 className="t1">Sân Bóng Chuyền</h1>
                    {loadingFields ? (
