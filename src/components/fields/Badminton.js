...
// ==========================
// Component chính: Trang Cầu Lông
// ==========================
const Badminton = () => {
    ...
    // Lọc sân cầu lông theo từ khóa truyền từ Home (nếu có)
    useEffect(() => {
        let result = fields.filter(
            (field) => field.type?.name?.toLowerCase() === "cầu lông"
        );
        ...
        <div className="font-sans">
            ...
            <main className="content-wrapper">
                ...
                <section className="fields-list-container">
                    <h1 className="t1">Sân Cầu Lông</h1>
                    {loadingFields ? (
