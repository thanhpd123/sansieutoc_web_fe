// src/components/coach/Coaches.js
...
const Coaches = () => {
    ...
    useEffect(() => {
        const fetchCoaches = async () => {
            try {
                const res = await axios.get("http://localhost:5000/coach");
                setCoaches(res.data);
            } catch (err) {
                ...
                <div className="footer-content">
                    ...
                    <div className="footer-column">
                        ...
                        <div className="social-icons">
                            <a href="https://facebook.com/sansieutoc" target="_blank" rel="noopener noreferrer">
                                <img src="https://img.icons8.com/ios-filled/24/ffffff/facebook-new.png" alt="Facebook" />
                            </a>
                            <a href="https://youtube.com/sansieutoc" target="_blank" rel="noopener noreferrer">
                                <img src="https://img.icons8.com/ios-filled/24/ffffff/youtube--v1.png" alt="Youtube" />
                            </a>
                            <a href="https://instagram.com/sansieutoc" target="_blank" rel="noopener noreferrer">
                                <img src="https://img.icons8.com/ios-filled/24/ffffff/instagram-new.png" alt="Instagram" />
                            </a>
                            <a href="https://tiktok.com/@sansieutoc" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="footer-column last-column">
                        ...
                        <img src="/images/logo_sansieutoc.png" alt="Sân Siêu Tốc Logo" className="footer-logo" />
                    </div>
                </div>
            </footer>
